...
drun "wget https://raw.githubusercontent.com/projectcalico/calico/$ver/manifests/custom-resources.yaml"
drun "sed -i 's/192\.168\.0\.0/10\.10\.0.0/g' custom-resources.yaml"
drun "kubectl apply -f custom-resources.yaml"
